...
var sequel = `${title}: The Path Ahead`;
...
if (pages < 1000) {
  ...
  console.log("Okay, maybe I could read that in a day in a half...")
};
...
var books = ["The Hobbit", "The Fellowship of the Ring", "The Two Towers", "The Return of the King", "The Silmarillion"];
...
var belowTwoHundred = [10, 25, 30, 45, 50, 65, 70, 85, 90, 105, 110, 125];

// Write the code to access the 5th element of the array, using bracket notation.
console.log("Fifth Number: " + belowTwoHundred[4]);
